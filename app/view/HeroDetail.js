                ...
                '<div class="base-stats">',
                    ...
                    '<div class="stats-group">',
                        '<div class="stats-row">',
                            ...
                            '<div class="attribute-value">{stats.strength} <span class="change d3-color-green">+25</span></div>',
                        '</div>',
                        '<div class="stats-row">',
                        ...
                        '<div class="stats-row">',
                            ...
                            '<div class="attribute-value">{stats.vitality} <span class="change d3-color-red">-25</span></div>',
                        '</div>',
                        '<div class="stats-row">',
                    ...
                    '<div class="stats-group">',
                        ...
                        '<div class="stats-row">',
                            ...
                            '<div class="attribute-value">{[(values.stats.critChance * 100).toFixed(1)]}%</div>',
                        '</div>',
                        '<div class="stats-row">',
                            '<div class="attribute-label">Critical Hit Damage</div>',
                            '<div class="attribute-value">{[(values.stats.critDamage * 100).toFixed(1)]}%</div>',
                        '</div>',
                        '<div class="stats-row">',
                            '<div class="attribute-label">Damage Increase</div>',
                            '<div class="attribute-value">{[(values.stats.damageIncrease * 100).toFixed(0)]}%</div>',
                        '</div>',
                    '</div>',
                    ...
                    '<div class="stats-group">',
                        ...
                        '<div class="stats-row">',
                            ...
                            '<div class="attribute-value">{[values.stats.lifeOnHit.toFixed(0)]}</div>',
                        '</div>',
                        '<div class="stats-row">',
                            '<div class="attribute-label">Life per Kill</div>',
                            '<div class="attribute-value">{[values.stats.lifePerKill.toFixed(0)]}</div>',
                        '</div>',
                        '<div class="stats-row">',
                            '<div class="attribute-label">Life Steal</div>',
                            '<div class="attribute-value">{[(values.stats.lifeSteal * 100).toFixed(0)]}%</div>',
                        '</div>',
                        '<div class="stats-row">',
